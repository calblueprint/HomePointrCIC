...
class ApplicationSubmissionWrapper extends React.Component {
  ...
  render() {
    return (
      ...
      >
        <ListView avatar={true} resources={this.props.selectedProperties} onSubmitProperty={this.props.onSubmitProperty} tenant={this.props.tenant} property_modal={true} type="property" checkbox={false} submission_modal={true} CheckboxChange={this.props.CheckboxChange}/>
      </div>
    );
  }
}
