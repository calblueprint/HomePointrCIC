...
class Tenant < ApplicationRecord
  ...
  validates :name, :description, :email, :phone, :rent_min, :rent_max, :housing_type, :property_type, :num_bedrooms, :location, :referral_agency_id, :date_needed, presence: true
