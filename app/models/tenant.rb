class Tenant < ApplicationRecord
	...
	enum housing_type: { other: 0, supported_housing: 1, temporary_hostel: 2, sheltered_housing: 3, private_sector_leasing: 4, private_property: 5, care_homes: 6, retired_housing: 7, council_housing: 8, housing_association: 9, student_housing: 10, mid-market_rent: 11, housing_first: 12 }
